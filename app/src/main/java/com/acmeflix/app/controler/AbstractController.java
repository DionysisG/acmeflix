...
import com.acmeflix.app.transfer.resource.BaseResource;

public abstract class AbstractController<T extends BaseModel, R extends BaseResource> extends BaseComponent {
